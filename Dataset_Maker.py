...
def process_file(path, output_dir_path):
    with open(path, 'r', encoding = 'utf-8') as f:
        ...
        for item in data:
            ...
            searching_file_path = f"E:\\unpacked\\eden\\voice\\" + item['File'].replace('/', '\\')
...
if __name__ == "__main__":
    process_folder("D:\\projects\\python\\Dataset_Maker_for_Galgames\\[minori]伊甸_Eden\\scripts_json", "datasets")
